...
class Enquiry extends CI_Controller
{
	...
	public function search(){
		...
		curl_setopt_array($curl, array(
			CURLOPT_URL => "https://ultraaligners.com/public/ultraaligners/items/enquiries?meta=total_count,result_count,filter_count&limit=200&offset=0&fields=status.*,title.*,details.*,token.*,id&q=".$quesry."",
