...
<head>
  ...
  <meta name="description" content="Here’s how Ultra Aligners helps deliver a smile you’ll love - safely, simply, and without monthly office visits. 
Our clear aligner system is designed for minor to moderate teeth correction.
Take 30 seconds to answer these questions and find out if we are the right choice for you.">
                            ...
                            <div class="navigation-top">
                                <div class="wrap">
                                    <ul class="navbar-nav nav-dropdown js-float-line align-items-center" data-app-modern-menu="true"><li class="nav-item">
                                            <a class="nav-link link display-4" href="index.html"><span class="socicon socicon-homeadvisor mbr-iconfont mbr-iconfont-btn"></span>&nbsp;Ultra Aligners</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link link display-4" href="getstarted.html"><span class="fa fa-bell-o mbr-iconfont mbr-iconfont-btn" style="font-size: 21px;"></span>Get Started</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link link display-4" href="index.html#features2-10"><span class="fa fa-medkit mbr-iconfont mbr-iconfont-btn" style="font-size: 21px;"></span>Treatable Cases </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link link display-4" href="index.html#title1-1k"><span class="socicon socicon-shopify mbr-iconfont mbr-iconfont-btn" style="font-size: 21px;"></span>Products</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link link display-4" href="index.html#extContacts3-9"><span class="mdi-action-question-answer mbr-iconfont mbr-iconfont-btn" style="font-size: 21px;"></span>lnquiries</a>
                                        </li><li class="nav-item"><a class="nav-link link display-4" href="index.html"><span class="fa fa-user-circle-o mbr-iconfont mbr-iconfont-btn"></span>&nbsp;<span style="font-weight: normal;">Login</span></a></li></ul>
                                </div>
                            </div>
                            <div class="right-box">
                                <div class="ml-auto">
                                    <div class="navbar-buttons mbr-section-btn"><a class="content-link link display-4" href="https://wa.me/447795116069">
                                            
                                        </a>
                                        <a class="content-link link display-4" href="#">
                                            
                                        </a>
                                         <a class="btn btn-sm btn-info display-4" href="getstarted.html">GET STARTED</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--Formbuilder Form-->
<form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="wt2HiGAnkkrgBGrUnZNl2zjsd0g/2w9MioJ7hFcSC33sIiQBgRYXypWe7QBbhZ1jUUjkByKLafUVVM+OALt/SMNP6GUEuoL7vTrEK4IpvEPQY3DkX/fwIK+AcIbH4ovE">
<div class="form-row">
