...
<section class="header5 cid-s9Kiz8hYQE mbr-fullscreen" id="header5-4">
    ...
    <div class="mbr-overlay" style="opacity: 0.1; background-color: rgb(0, 127, 255);">
    </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="wrap d-flex flex-column align-items-start">
                    ...
                    <h1 class="mbr-section-title align-center mbr-fonts-style display-2">Journey To&nbsp;<span class="accent-word mbr-fonts-style">Perfect</span>&nbsp;Smile<br></h1>
                    
                    <div class="buttons-wrap d-flex mt-4">
                        <div class="mbr-section-btn align-center"><a class="btn btn-lg btn-info display-4" href="Candidates.html#extContent5-h">AM I A CANDIDATE?</a></div>
                        <div class="video-wrap d-flex align-items-center">
                            ...
                            <h4 class="mbr-text mbr-fonts-style align-self-center ml-3 my-auto mbr-bold display-4">
                                <strong><a href="https://youtu.be/WX7ylN1j4-c" class="text-info"><b>WATCH VIDEO</b></a>
                            </strong></h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="modalWindow-container">
                <div class="modalWindow-video-container">
                    <div class="modalWindow-video">
                        <iframe width="100%" height="100%" frameborder="0" allowfullscreen="1" data-src="https://youtu.be/WX7ylN1j4-c"></iframe>
                    </div>
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mb-4 content-container" style="width: 85%;">
                <h1 class="mbr-section-title pb-3 mbr-fonts-style display-2">Straight teeth in <strong>just 3 steps.</strong></h1>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="mbr-text mbr-fonts-style align-center card-text display-7"><p>No suffering from gum disease.</p></div>
    ...
    <div class="container align-center">
        ...
        <div class="timelines-container" mbri-timelines="">
            ...
            <div class="row timeline-element first-separline separline">
                ...
                <div class="col-xs-12 col-md-7">
                    <div class="timeline-text-content">
                        <h4 class="mbr-timeline-title mbr-fonts-style display-5">Establishment</h4>
            ...
            <div class="row timeline-element  separline">
                ...
                <div class="col-xs-12 col-md-7">
                    <div class="timeline-text-content">
                        <h4 class="mbr-timeline-title mbr-fonts-style display-5">Service Locations</h4>
                        <p class="mbr-timeline-text mbr-fonts-style display-7">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam erat libero, bibendum in libero
                            tempor, luctus volutpat ligula.
                            Integer fringilla porttitor pretium. Nam erat felis, iaculis id justo ut, ullamcorper
            ...
            <div class="row timeline-element">
                ...
                <div class="col-xs-12 col-md-7">
                    <div class="timeline-text-content">
                        <h4 class="mbr-timeline-title mbr-fonts-style display-5">Practices &amp; Pricing</h4>
                        <p class="mbr-timeline-text mbr-fonts-style display-7">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam erat libero, bibendum in libero
                            tempor, luctus volutpat ligula.
                            Integer fringilla porttitor pretium. Nam erat felis, iaculis id justo ut, ullamcorper
    ...
    <div class="container">
        <div class="media-container-row content text-white">
                    ...
                    <div class="list-item d-flex">
                        ...
                        <div class="content d-flex flex-column justify-content-center">
                            <h4 class="link-wrap mbr-fonts-style display-4">Improvements In
                                Technology
                                </h4><h4 class="date-wrap mbr-fonts-style display-4">February 21, 2020
                                </h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                ...
                <li class="clearfix">Mon - Tue<span>11.00 - 19.00</span></li><li class="clearfix">Wed - Thur<span>09.30 - 16.30</span></li><li class="clearfix">Fri - Sat<span>11.30 - 20.00</span></li><li class="clearfix">Saturday<span>10.30 - 12.00</span></li><li class="clearfix">Sunday<span>Closed</span></li></div>
            </div>
        </div>
    </div>
</section>
